...
const orders = await $fetch("/api/admin/orders/get-all-orders", {});

// const ordersKeys = computed(() => {
//     return
// })
</script>
<template>
                            ...
                            >
                                <div class="relative inline-block">
                                    <div>
                                        ...
                                        >
                                            <div
                                                class="p-2 bg-white border border-gray-200 rounded-2xl shadow-lg dark:border-gray-800 dark:bg-gray-900 w-40"
                                                style="display: none"
                                            >
                                                <div
                                                    class="space-y-1"
